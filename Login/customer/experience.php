...
<!-- NAVIGATION STARTS-->
    ...
    <div class="cv" style="padding: 0 70px 20px 100px;">
        ...
        <div class="table" style="padding-left: 60px;"><br>
            <caption><h5 style="text-align: center;">Experience Details<h5></caption><br>
            <table border="3" cellspacing="5">
                ...
                <tr>
                    ...
                    <td><?=$row["address"]?></td>
                    <td><div class="button">
                    <a style="color:white;" href="./updateExperiences.php?expId=<?=$row['expId']?>">
                    <button name="submit" value="submit">Update</button>
                    </a>
                    </div></td>
                    <td style="padding:10px;"><div class="button">
                    <?php $_SESSION['expId'] = $row["expId"]; ?>
            ...
            <form action="addExperience.php" class="add" METHOD="POST">
