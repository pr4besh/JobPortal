...
<!-- NAVIGATION STARTS-->
    ...
    <div class="left" style="padding-left:200px;text-align:center;">
              ...
              $query = "Select jobField from personalInformation where cusId = $regId";
              $result = mysqli_query($conn, $query);
              while($row=mysqli_fetch_array($result)){ $field = $row["jobField"];}

              $sql="select jobId, jobPosition, companyName, deadline from jobs where jobField = '$field' and deadline>now()";
