...
<!-- NAVIGATION STARTS-->
    ...
    <div class="cv" style="padding: 0 70px 20px 100px;">
        ...
        <div class="table" style="padding-left: 60px;"><br>
            <caption><h5 style="text-align: center;">Update Responsibilities Details<h5></caption><br>
            <table border="3" cellspacing="5">
                ...
                $sql="Select details, responsibilitiesId from responsibilities where cusId = '$regid'";
                ...
                <tr>
                    ...
                    <a style="color:white;" href="./updateResponsibilities.php?resId=<?=$row['responsibilitiesId']?>">
                    <button name="submit" value="submit">Update</button>
                    </a>
                    </div></td>
                    <td style="padding:10px;"><div class="button">
                    <?php $_SESSION['resId'] = $row["responsibilitiesId"]; ?>
                ...
                <?php
                    if(isset($_POST['delete']))
                    {
                        ...
                        $insertQuery = "Delete from responsibilities where responsibilitiesId = '$resId' and cusId = '$regid'";
                        ...
                        if($result)
                            ...
                            {
                                echo'<script>window.location.replace("responsibilities.php");</script>';
                            }
                    }
                ?>
            </table><br><br>
            <form action="addResponsibilities.php" class="add" METHOD="POST">
